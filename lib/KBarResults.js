...
var KBarResults = function (props) {
    ...
    React.useEffect(function () {
        var handler = function (event) {
            ...
            if (event.key === "ArrowUp" || (event.ctrlKey && event.key === "p")) {
                ...
                (_a = activeRef.current) === null || _a === void 0 ? void 0 : _a.dispatchEvent(clickEvent);
            }
        };
    ...
    var execute = React.useCallback(function (item, ev) {
        var _a, _b;
        if (typeof item === "string")
            return;
        if (item.command) {
            var perfRes = item.command.perform(item, ev);
    ...
    return (React.createElement("div", { ref: parentRef, style: {
        ...
        React.createElement("div", { role: "listbox", id: KBarSearch_1.KBAR_LISTBOX, style: {
            ...
            var handlers = typeof item !== "string" && {
                ...
                onClick: function (ev) { return execute(item, ev); },
            };
